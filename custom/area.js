...
var width1 = 120;
var height1 = 500;
var margin1 = {top: 30, right: 0, bottom: 0, left: 15};

// Area 2 Chart

var width2 = 500;
var height2 = 500;
var margin = {top: 87, right: 50, bottom: 156, left: 50};
...
var svg2 = d3.select("#chart-stage").append("svg")
    ...
    svg2.append("g") // X - Achse
        ...
        .style("font-size", "10")
        .attr("transform", "translate("+ 42 + "," + 370 + ")");
...
var svg4 = d3.select("#control-panel").append("svg")
    .attr("width", 250)
    .attr("height", 150)
    .attr("id","addGroup");
